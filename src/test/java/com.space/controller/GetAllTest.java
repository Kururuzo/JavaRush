                ...
                testsHelper.getShipInfosByShipType(ShipType.MILITARY,
                        testsHelper.getShipInfosByAfter(32503672800000L,
                                testsHelper.getShipInfosByBefore(32850741600000L,
                                        testsHelper.getAllShips()))));
//        System.out.println("actual before = " + new SimpleDateFormat("yyyy.MM.dd hh:mm").format(32850741600000L) + ", 32850741600000L" );
//        for (ShipInfoTest shipInfoTest : actual) {
//            System.out.println("     "  + shipInfoTest.name + ", prod date = " +
//                    new SimpleDateFormat("yyyy.MM.dd hh:mm").format(shipInfoTest.prodDate) +
//                    ", in mills = " + shipInfoTest.prodDate
////                    ", expected = " + new SimpleDateFormat("yyyy.MM.dd hh:mm").format(32850741600000L) +
////                    ",  mills = " + 32850741600000L
//            );
//        }
//        System.out.println("");
//        System.out.println("expected before = " + new SimpleDateFormat("yyyy.MM.dd hh:mm").format(32850741600000L) + ", 32850741600000L" );
//        for (ShipInfoTest shipInfoTest : expected) {
//            System.out.println("     "  + shipInfoTest.name + ", prod date = " +
//                    new SimpleDateFormat("yyyy.MM.dd hh:mm").format(shipInfoTest.prodDate) +
//                    ", in mills = " + shipInfoTest.prodDate
////                    ", expected = " + new SimpleDateFormat("yyyy.MM.dd hh:mm").format(32850741600000L) +
////                    ", in mls = " + 32850741600000L
//            );
//        }
...
//        System.out.println("");
//        System.out.println("expected = { crew min = 20, max = 1500 }");
//        for (ShipInfoTest shipInfoTest : expected) {
//            System.out.println(shipInfoTest.name
//                    + ", "
//                    + new SimpleDateFormat("yyyy.MM.dd hh:mm").format(shipInfoTest.prodDate)
//                    + ", in mills = " + shipInfoTest.prodDate
//                    + ", crew = " + shipInfoTest.crewSize);
//        }
